...
namespace MM2Randomizer.Randomizers
{
    public class RWeaponBehavior : IRandomizer
    {
        ...
        protected void ChangeHeat(Patch in_Patch, ISeed in_Seed, List<ESoundID> in_Sounds)
        {
            ...
            in_Patch.Add(0x07DE55, L1Ammo, $"(H) | Shot L1 Ammo Cost: {L1Ammo}");
            in_Patch.Add(0x07DE56, L1Ammo, $"(H) | Shot L2 Ammo Cost: {L1Ammo}");

            Byte[] bytes = new Byte[] { 0x01, 0x01, 0x02, 0x02, 0x02, 0x02, 0x03, 0x03, };
            Int32 rInt = in_Seed.NextInt32(bytes.Length);
            in_Patch.Add(0x07DE57, bytes[rInt], $"(H) | Shot L3 Ammo Cost: {bytes[rInt]}");
            ...
            in_Patch.Add(0x07DD61, (Byte)chargeDelayL2, "(H) | L2 Charge Delay");
        ...
        protected void ChangeAir(Patch in_Patch, ISeed in_Seed, List<ESoundID> in_Sounds)
        {
            ...
            in_Patch.Add(0x07DAD6, (Byte)numProjectiles, "(A) | Number of Projectiles");
            ...
            ESoundID sound = this.GetRandomSound(in_Seed, in_Sounds);
            in_Patch.Add(0x07DAE6, (Byte)sound, "(A) | Sound");

            //0x03DAEE - A ammo used(0x02)
            Int32 ammoUse = in_Seed.NextInt32(0x02) + 0x01;
            in_Patch.Add(0x07DAEE, (Byte)ammoUse, "(A) | Ammo Use");
            ...
            in_Patch.Add(0x07DE6E, (Byte)yAccFrac, "(A) | Y-Acceleration (fraction)");
            ...
            in_Patch.Add(0x07DE76, (Byte)yAccInt, "(A) | Y-Acceleration (integer)");
            ...
            for (Int32 i = 0; i < 3; i++)
            {
                ...
                in_Patch.Add(0x07DE7E + i, (Byte)xFracSpeed, String.Format("(A) | Projectile {0} X-Velocity (fraction)", i + 1));
            }
            ...
            for (Int32 i = 0; i < 3; i++)
            {
                ...
                in_Patch.Add(0x07DE81 + i, (Byte)xIntSpeed, String.Format("(A) | Projectile {0} X-Velocity (integer)", i + 1));
            }
        }
        ...
        protected void ChangeWood(Patch in_Patch, ISeed in_Seed, List<ESoundID> in_Sounds)
        {
            ...
            in_Patch.Add(0x07DEDA, (Byte)deployDelay, "(W) | Deploy Delay");
            ...
            ESoundID sound = this.GetRandomSound(in_Seed, in_Sounds);
            in_Patch.Add(0x07DF1F, (Byte)sound, "(W) | Deploy Sound");
            ...
            {
                in_Patch.Add(0x07DF50, 0x29, "(W) | Reverse X-Direction Code AND");
                in_Patch.Add(0x07DF51, 0x40, "(W) | Reverse X-Direction Code #$40");
                in_Patch.Add(0x07DF52, 0xEA, "(W) | Reverse X-Direction Code NOP"); // (best thing i could find to simply "skip" a line)
            }
            
            //0x03DF59 - W x - speed(04) (do 0x02-0x08)
            Int32 launchVel = in_Seed.NextInt32(0x06) + 0x02;
            in_Patch.Add(0x07DF59, (Byte)launchVel, "(W) | Launch X-Velocity Integer");
            ...
            in_Patch.Add(0x07DF7D, (Byte)launchVel, "(W) | Launch Y-Velocity Integer");
        }
        ...
        protected void ChangeBubble(Patch in_Patch, ISeed in_Seed, List<ESoundID> in_Sounds)
        {
            ...
            in_Patch.Add(0x07D4AB, (Byte)xVelShoot, "(B) | X-Velocity Shoot (Integer)");

            //0x03D4CF - B y - speed on shoot(0x02) (do 0-6)
            Int32 yVelShoot = in_Seed.NextInt32(0x06);
            in_Patch.Add(0x07D4CF, (Byte)yVelShoot, "(B) | Y-Velocity Shoot (Integer)");
            ...
            in_Patch.Add(0x07DB21, (Byte)maxShots, "(B) | Max Shots");
            ...
            ESoundID sound = this.GetRandomSound(in_Seed, in_Sounds);
            in_Patch.Add(0x07DB34, (Byte)sound, "(B) | Sound");

            //0x03DB3D - B shots per ammo tick (0x02) (do 1-4)
            Int32 magSize = in_Seed.NextInt32(0x04) + 0x01;
            in_Patch.Add(0x07DB3D, (Byte)magSize, "(B) | Shots Per Ammo Tick");
            ...
            in_Patch.Add(0x07DFA9, (Byte)xVelRoll, "(B) | X-Velocity Surface (Integer)");
            ...
            in_Patch.Add(0x07DFC0, (Byte)xVelFall, "(B) | X-Velocity Fall (Integer)");
            ...
            in_Patch.Add(0x07DFC8, (Byte)yFallVel, "(B) | Y-Velocity Fall (Integer)");
        }
        ...
        protected void ChangeQuick(Patch in_Patch, ISeed in_Seed, List<ESoundID> in_Sounds)
        {
            ...
            in_Patch.Add(0x07DFE2, (Byte)distance, "(Q) | Travel Distance");

            // Q behavior, initial angle, default 0x4B
            //    Do from 0x00 to 0x60 ?
            Int32 angle1 = in_Seed.NextInt32(0x60);
            in_Patch.Add(0x07DFEA, (Byte)angle1, "(Q) | Initial Angle");
            ...
            in_Patch.Add(0x07DFFF, (Byte)angle2, "(Q) | Secondary Angle");
            ...
            in_Patch.Add(0x07E007, (Byte)despawnDelay, "(Q) | Despawn Delay");

            // Q behavior, return angle, default 0x4B
            //    Do from 0x00 to 0x90
            Int32 angle3 = in_Seed.NextInt32(0x90);
            in_Patch.Add(0x07E013, (Byte)angle3, "(Q) | Return Angle");
        ...
        protected void ChangeFlash(Patch in_Patch, ISeed in_Seed, List<ESoundID> in_Sounds)
        {
            //0x03DC59 - F sound (21)
            ESoundID sound = this.GetRandomSound(in_Seed, in_Sounds);
            in_Patch.Add(0x07DC59, (Byte)sound, "(F) | Sound");
            ...
            if (rTestFChange > 0.25)
            {
                ...
                {
                    in_Patch.Add(0x07E172 + i, sub[i], "(F) | Reusable Time-Stopper Subroutine");
                }
                ...
                in_Patch.Add(0x07E16E, (Byte)duration, "(F) | Freeze Duration (1)");
                in_Patch.Add(0x07D49D, (Byte)duration, "(F) | Freeze Duration (2)");
                ...
                for (Int32 i = 0; i < sub.Length; i++)
                {
                    in_Patch.Add(0x07DC41 + i, sub[i], "(F) | Reusable Time-Stopper Ammo-Underflow Fix");
                }
            }
            else
            {
                ...
                in_Patch.Add(0x07E16E, (Byte)tickDelay, "(F) | Time-Stopper Ammo Tick Delay (1)");
                in_Patch.Add(0x07D49D, (Byte)tickDelay, "(F) | Time-Stopper Ammo Tick Delay (2)");
            }
        }
        ...
        protected void ChangeMetal(Patch in_Patch, ISeed in_Seed, List<ESoundID> in_Sounds)
        {
            ...
            Int32 maxShots = in_Seed.NextInt32(0x04) + 0x02;
            in_Patch.Add(0x07DBB6, (Byte)maxShots, "(M) | Max Shots");

            //0x03DBC9 - M sound effect(23)
            ESoundID sound = this.GetRandomSound(in_Seed, in_Sounds);
            in_Patch.Add(0x07DBC9, (Byte)sound, "(M) | Sound");

            //0x03DBD2 - M shots per ammo tick(04) (change to 1-5)
            Int32 magSize = in_Seed.NextInt32(0x05) + 0x01;
            in_Patch.Add(0x07DBD2, (Byte)magSize, "(M) | Shots Per Ammo Tick");
            ...
            in_Patch.Add(0x07DC12, (Byte)velY, "(M) | Y-Velocity Up");

            //0x03DC31 - M x - speed, no direction(04)
            in_Patch.Add(0x07DC31, (Byte)velX, "(M) | X-Velocity Neutral");

            //0x03DC35 - M x - speed, holding left(04)
            in_Patch.Add(0x07DC35, (Byte)velX, "(M) | X-Velocity Left");

            //0x03DC39 - M x - speed, holding right(04)
            in_Patch.Add(0x07DC39, (Byte)velX, "(M) | X-Velocity Right");

            //0x03DC13 - M y - speed, holding down(FC)
            in_Patch.Add(0x07DC13, (Byte)(0x00 - (Byte)velY), "(M) | Y-Velocity Down");

            //0x03DC16 - M y - speed, holding up + left(02)
            in_Patch.Add(0x07DC16, (Byte)halfY, "(M) | Y-Velocity Up+Left");

            //0x03DC17 - M y - speed, holding down + left(FD)
            in_Patch.Add(0x07DC17, (Byte)(0x00 - (Byte)halfY), "(M) | Y-Velocity Down+Left");

            //0x03DC1A - M y - speed, holding up + right(02)
            in_Patch.Add(0x07DC1A, (Byte)halfY, "(M) | Y-Velocity Up+Right");

            //0x03DC1B - M y - speed, holding down + right(FD)
            in_Patch.Add(0x07DC1B, (Byte)(0x00 - (Byte)halfY), "(M) | Y-Velocity Down+Right");

            //0x03DC36 - M x - speed, holding up + left(02)
            in_Patch.Add(0x07DC36, (Byte)halfX, "(M) | X-Velocity Up+Left");

            //0x03DC37 - M x - speed, holding down + left(02)
            in_Patch.Add(0x07DC37, (Byte)halfX, "(M) | X-Velocity Down+Left");

            //0x03DC3A - M x - speed, holding up + right(02)
            in_Patch.Add(0x07DC3A, (Byte)halfX, "(M) | X-Velocity Up+Right");

            //0x03DC3B - M x - speed, holding down + right(02)
            in_Patch.Add(0x07DC3B, (Byte)halfX, "(M) | X-Velocity Down+Right");
        }
        ...
        protected void ChangeCrash(Patch in_Patch, ISeed in_Seed, List<ESoundID> in_Sounds)
        {
            ...
            in_Patch.Add(0x07D4AD, (Byte)xVel, "(C) | X-Velocity (Integer)");
            ...
            in_Patch.Add(0x07D4D7, (Byte)yVelExplode, "(C) | X-Velocity (Explosion)");

            //0x03DB99 - C ammo per shot (04) (do 1-3)
            Int32 ammoUse = in_Seed.NextInt32(0x03) + 0x01;
            in_Patch.Add(0x07DB99, (Byte)ammoUse, "(C) | Ammo Usage");
            ...
            in_Patch.Add(0x07DB9F, (Byte)multiExplode, "(C) | Explosion Type");

            //0x03DBA6 - C shoot sound effect (24)
            ESoundID sound = this.GetRandomSound(in_Seed, in_Sounds);
            in_Patch.Add(0x07DBA6, (Byte)sound, "(C) | Sound Shoot");

            //0x03E089 - C attach sound effect (2E)
            sound = this.GetRandomSound(in_Seed, in_Sounds);
            in_Patch.Add(0x07E089, (Byte)sound, "(C) | Sound Attach");

            //0x03E09C - C delay before explosion (7E) (do 01 to C0)
            Int32 delayExplosion = in_Seed.NextInt32(0xBF) + 0x01;
            in_Patch.Add(0x07E09C, (Byte)delayExplosion, "(C) | Explode Delay");

            //0x03E0DA - C explode sound effect
            sound = this.GetRandomSound(in_Seed, in_Sounds);
            in_Patch.Add(0x07E0DA, (Byte)sound, "(C) | Sound Explode");
        }
        ...
        protected void ChangeItem1(Patch in_Patch, ISeed in_Seed)
        {
            ...
            in_Patch.Add(0x07E1AC, (Byte)rInt, "(1) | Delay Before Flashing");
            ...
            in_Patch.Add(0x07E1BF, (Byte)rInt, "(1) | Delay Before Despawn");
            ...
            in_Patch.Add(0x07D4C2, (Byte)rXVelFracs[rInt], "(1) | Y-Velocity (Fraction)");
        }
